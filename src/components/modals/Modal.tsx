...
const Modal:React.FC<ModalProps> = ({
  ...
  const handleClose=useCallback(()=>{
    if(disabled){return;}
    setTimeout(()=>{onClose();},300)},[disabled,onClose]);
  const handleSubmit=useCallback(()=>{if(disabled){return;}onSubmit()},[disabled,onSubmit]);
  const handleSecondaryAction=useCallback(()=>{if(disabled||!secondaryAction){return;}secondaryAction()},[disabled,secondaryAction]);
    ...
    <>
      <div className="justify-center items-center flex overflow-x-hidden 
       ...
       focus:outline-none bg-neutral-800/70">
                        ...
                        my-6 mx-auto h-[98%] lg:h-auto md:h-auto" >
                                {/* CONTENT */}
                                  ...
                                  ${showModal ?"opacity-100":"opacity-0"}`}>
                                      ...
                                      outline-none focus:outline-none">
                                          ...
                                          <div className="flex items-center p-6 rounded-t justify-center relative border-b-[1px]">
                                            ...
                                            transition absolute right-9"> <IoMdClose size={18}/></button>
                                          ...
                                          <div className="p-6 relative flex-auto">{body}</div>
                                           ...
                                           <div className="p-6 flex flex-col gap-2">
                                              <div className="flex flex-row items-center gap-4 w-full">
                                                ...
                                                <Button  disabled={disabled} label={actionLabel} onClick={handleSubmit}/></div>
                                                {footer}
                                           </div>
                                      </div>
                                  </div>
